...
function App() {
  ...
  const handleQuizGenerate = async () => {
    ...
    try {
      ...
      if (res.data.quiz) {
        const parsedQuestions = parseQuizOutput(
          res.data.quiz,
          numOptions,
          questionType
        );
  ...
  const handleExport = () => {
    ...
    switch (exportFormat) {
      ...
      case "pdf":
        ...
        break;
      case "json":
        handleExportJSON(filtered);
        break;
      case "txt":
        handleExportTXT(filtered);
        break;
      default:
        break;
    }
  ...
  // Add this function to handle navigation to subscription page
    ...
    <div className={`app-container ${theme}`}>
      ...
      <aside className={`sidebar ${isMenuCollapsed ? "collapsed" : ""}`}>
        ...
        <nav className="menu-tiles">
          <button
            className={`menu-tile ${
              activeMenuTile === "dashboard" ? "active" : ""
            }`}
            onClick={() => {
              setActiveMenuTile("dashboard");
              navigate("/");
            }}
            title="Dashboard"
          >
          ...
          <button
            className={`menu-tile ${
              activeMenuTile === "subscription" ? "active" : ""
            }`}
            onClick={() => {
              setActiveMenuTile("subscription");
              navigateToSubscription();
            }}
            title="Subscription"
          >
            <FiCreditCard className="tile-icon" />
            {!isMenuCollapsed && <span>Subscription</span>}
          </button>

          <button
            className={`menu-tile ${
              activeMenuTile === "history" ? "active" : ""
            }`}
          ...
          <button
            className={`menu-tile ${
              activeMenuTile === "settings" ? "active" : ""
            }`}
        ...
        <div className="sidebar-footer">
          {isAuthenticated ? (
            ...
            <Link to="/login" className="menu-tile" title="Login">
                        ...
                        <div className="section-content">
                          {!questions.length && !loading && (
                            <div className="empty-state">
                              No quiz generated yet. Enter some text and click
                              "Generate Quiz".
                            </div>
                          )}
